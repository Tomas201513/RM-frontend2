...
const CreateUpdatePosition = ({ selectedData, editable, setEditable, name}) => {
    const {  setCreateOpen, createPosition, updatePosition, deletePosition, warn, SetWarn ,setSelectedData} = useContext(PositionContext);
      ...
      const FormSchema = yup.object().shape({
        ...
        const handleSubmit = async (values) => {
            try {
                if (selectedData) {
                  console.log("update positiooooooooon",selectedData._id);
