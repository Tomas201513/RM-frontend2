...
import { CatSubCatagory,GetSubCatagory, GetSubCatagoryDetail, CreateSubCatagory, UpdateSubCatagory, DeleteSubCatagory,} from "../apis/SubCatagoryApi";
...
export const SubCatagoryProvider = ({ children }) => {
    ...
    const [createOpen, setCreateOpen] = React.useState(false);
        ...
        const CatqueryResult = useQuery("Catsubcatagory", CatSubCatagory);

        const isLoadingCat = CatqueryResult.isLoading;
        const errorCat = CatqueryResult.error;
        const CatsubcatagoryData = CatqueryResult.data;
        const CAtrefetch = CatqueryResult.refetch;
        console.log("xxxxxxxxxxxxx-->",subcatagoryData);
        console.log("yyyyyyyyyyyyy-->",subcatagoryData);
