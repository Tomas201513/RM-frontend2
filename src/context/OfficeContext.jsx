...
import {GetOffice, CreateOffice, UpdateOffice, DeleteOffice} from "src/apis/OfficeApi";
...
export const OfficeProvider = ({ children }) => {
    ...
    const  recentcount = queryResult?.data?.count;
    const officeData = queryResult?.data?.offices || [];
