...
import HRgeneral from './pages/HR/HRgeneral.jsx';
import Detail from './pages/Detail/Detail';
import ItTab from 'src/pages/it/ItTab'
import ProcGeneral from './pages/Logistics/Procurment/ProcGeneral'
      ...
      <Route element={<PrivateRoute />} >
        <Route path="/app" element={<DashboardLayout />} >
          <Route path="/app/account" element={<Account />} />
            ...
            <Route path="/app/hr" element={<HRgeneral />} />
            <Route path="/app/detail" element={<Detail/>} />
            <Route path="/app/it" element={<ItTab/>} />
            <Route path="/app/procurement" element={<ProcGeneral/>} />  
